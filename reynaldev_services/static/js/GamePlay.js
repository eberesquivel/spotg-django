...
GamePlayManager = {
    ...
    preload: function() {
        game.load.image('background', src="{% static 'img/background.png' %  }" );
        game.load.spritesheet('horse', src="{% static 'img/background.png',84,156,2 %  }");
        ...
        this.timerGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
            if(this.flagFirstMouseDown){
                ...
                if(this.totalTime<=0){
                    ...
                    this.endGame = true;
                    this.showFinalMessage('TERMINA JUEGO');
                }
            }
        },this);
